...
print("\n1. Users:")
user_a = create_user(
    "e2e_user_a@test.com", "e2e_user_a", "TestPass123!", "Alice", "Tester", True
)
user_b = create_user(
    "e2e_user_b@test.com", "e2e_user_b", "TestPass123!", "Bob", "Tester", True
)
user_c = create_user(
    "e2e_user_c@test.com", "e2e_user_c", "TestPass123!", "Carol", "Private", False
)
