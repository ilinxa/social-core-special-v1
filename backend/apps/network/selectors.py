...
class FollowSelector:
    ...
    @staticmethod
    def is_following(
        *, follower_id: UUID, followee_type: str, followee_id: UUID,
    ) -> bool:
    ...
    @staticmethod
    def get_followers(
        *, followee_type: str, followee_id: UUID,
    ) -> QuerySet[Follow]:
        return Follow.objects.filter(
            followee_type=followee_type,
            followee_id=followee_id,
    ...
    @staticmethod
    def get_following(
        *, user_id: UUID, followee_type: str = None,
    ) -> QuerySet[Follow]:
...
class ConnectionSelector:
    ...
    def is_connected_account(
        *, a_type: str, a_id: UUID, b_type: str, b_id: UUID,
    ) -> bool:
    ...
    def get_user_connections(
        *, user_id: UUID, status: str = ConnectionStatus.ACTIVE,
    ) -> QuerySet[Connection]:
        return Connection.objects.filter(
            connection_type=ConnectionType.USER_USER,
            status=status,
