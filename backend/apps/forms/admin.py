...
class FormTemplateAdmin(admin.ModelAdmin):
    list_display = ["name", "slug", "owner_type", "scope", "status", "version", "is_current", "created_at"]
...
class FormResponseAdmin(admin.ModelAdmin):
    list_display = ["id", "form_template", "submitted_by", "status", "submitted_at", "processed_at"]
    list_filter = ["status"]
    search_fields = ["id"]
