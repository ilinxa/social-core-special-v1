    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Form display name", max_length=255),
                ),
                (
                    "slug",
                    models.SlugField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "processed_at",
                    models.DateTimeField(
                        blank=True, help_text="When response was processed", null=True
                    ),
                ),
                (
                    "processor_notes",
                    models.TextField(
                        blank=True, default="", help_text="Notes from processor"
                    ),
                ),
                (
                    "created_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "field_key",
                    models.CharField(
                        help_text="Machine-readable field identifier", max_length=100
                    ),
                ),
                (
                    "field_type",
                ...
                (
                    "is_required",
                    models.BooleanField(
                        default=False, help_text="Field must have a value"
                    ),
                ),
                (
                    "is_indexed",
                ...
                (
                    "is_readonly",
                    models.BooleanField(
                        default=False, help_text="Displayed but not editable"
                    ),
                ),
                (
                    "form_template",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="form_decima_respons_a30ad8_idx",
                    ),
                    models.Index(
                        fields=["field_key", "value"],
                        name="form_decima_field_k_d22898_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["response", "field_key"],
                        name="form_dateti_respons_1c3d36_idx",
                    ),
                    models.Index(
                        fields=["field_key", "value"],
                        name="form_dateti_field_k_bd068d_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["response", "field_key"],
                        name="form_date_f_respons_f7313c_idx",
                    ),
                    models.Index(
                        fields=["field_key", "value"],
                        name="form_date_f_field_k_5a5675_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["response", "field_key"],
                        name="form_boolea_respons_8cdd9f_idx",
                    ),
                    models.Index(
                        fields=["field_key", "value"],
                        name="form_boolea_field_k_95dd75_idx",
                    ),
                ],
            },
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["owner_type", "owner_id"], name="form_templa_owner_t_079cb7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="formtemplate",
            index=models.Index(
                fields=["scope", "status"], name="form_templa_scope_15e7e5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="formtemplate",
            index=models.Index(
                fields=["is_template_public", "status"],
                name="form_templa_is_temp_8f1218_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="formtemplate",
            index=models.Index(
                fields=["owner_type", "owner_id", "is_current"],
                name="form_templa_owner_t_39a5e8_idx",
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["form_template", "status"],
                name="form_respon_form_te_3a3468_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="formresponse",
            index=models.Index(
                fields=["submitted_by", "status"], name="form_respon_submitt_a8e23a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="formresponse",
            index=models.Index(
                fields=["form_template", "submitted_at"],
                name="form_respon_form_te_0e7694_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="formresponse",
            index=models.Index(
                fields=["status", "-submitted_at"], name="form_respon_status_e595d8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="formfield",
            index=models.Index(
                fields=["form_template", "order"], name="form_field_form_te_76956e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="formfield",
            index=models.Index(
                fields=["form_template", "step_tag"],
                name="form_field_form_te_89a9e5_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="formfield",
            index=models.Index(
                fields=["form_template", "is_indexed"],
                name="form_field_form_te_fb1f64_idx",
            ),
        ),
        migrations.AddConstraint(
            model_name="formfield",
            constraint=models.UniqueConstraint(
                fields=("form_template", "field_key"), name="unique_field_key_per_form"
            ),
        ),
        migrations.AddIndex(
            model_name="integerfieldindex",
            index=models.Index(
                fields=["response", "field_key"], name="form_intege_respons_653ac3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="integerfieldindex",
            index=models.Index(
                fields=["field_key", "value"], name="form_intege_field_k_a50795_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="textfieldindex",
            index=models.Index(
                fields=["response", "field_key"], name="form_text_f_respons_e46058_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="textfieldindex",
            index=models.Index(
                fields=["field_key", "value"], name="form_text_f_field_k_7fbf06_idx"
            ),
        ),
    ]
