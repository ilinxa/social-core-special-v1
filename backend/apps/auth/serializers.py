...
class RegisterSerializer(serializers.Serializer):
    ...
    referred_by = serializers.CharField(
        required=False,
        allow_blank=True,
        help_text="Referral code (optional)"
    )
    ...
    device_name = serializers.CharField(
        required=False,
        default='',
        help_text="Device name (e.g., 'Chrome on Windows')"
    )
...
class RefreshTokenSerializer(serializers.Serializer):
    ...
    refresh_token = serializers.CharField(
        required=False,  # Can be in cookie for web clients
...
class LogoutSerializer(serializers.Serializer):
    ...
    refresh_token = serializers.CharField(
        required=False,  # Can be in cookie
...
class ResendVerificationSerializer(serializers.Serializer):
    ...
    email = serializers.EmailField(
        help_text="Email address to send verification to"
    )
...
class OAuthInitSerializer(serializers.Serializer):
    ...
    redirect_to = serializers.CharField(
        required=False,
        help_text="URL to redirect to after OAuth"
    )
...
class OAuthCallbackSerializer(serializers.Serializer):
    ...
    user = serializers.CharField(
        required=False,
        help_text="User data (Apple only, first sign-in)"
    )
