...
class TestJWTAuthentication:
    ...
    @patch("apps.auth.services.auth_service.AuthService.validate_access_token")
    def test_raises_token_invalid_default_message(
        self, mock_validate, factory, jwt_auth
    ):
    ...
    @patch("apps.auth.services.auth_service.AuthService.validate_access_token")
    def test_raises_token_already_used_with_code(
        self, mock_validate, factory, jwt_auth
    ):
...
class TestJWTAuthenticationOptional:
    ...
    def test_returns_none_when_no_authorization_header(
        self, factory, jwt_auth_optional
    ):
        """authenticate() should return None when no Authorization header is present."""
        request = _make_request(factory)
    ...
    @patch("apps.auth.services.auth_service.AuthService.validate_access_token")
    def test_returns_none_for_bearer_with_no_token(
        self, mock_validate, factory, jwt_auth_optional
    ):
    ...
    @patch("apps.auth.services.auth_service.AuthService.validate_access_token")
    def test_returns_none_for_token_with_spaces(
        self, mock_validate, factory, jwt_auth_optional
    ):
    ...
    @patch("apps.auth.services.auth_service.AuthService.validate_access_token")
    def test_returns_none_for_unexpected_exception(
        self, mock_validate, factory, jwt_auth_optional
    ):
