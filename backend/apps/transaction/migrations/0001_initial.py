    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("user", "User"),
                            ("account", "Account"),
                            ("membership_actor", "Membership Actor"),
                            ("system", "System"),
                        ],
                        max_length=20,
                    ),
                ...
                (
                    "initiator_id",
                    models.UUIDField(help_text="User UUID or Membership UUID"),
                ),
                (
                    "initiator_context",
                    models.JSONField(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="transaction_transac_dd72b0_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                ...
                name="transaction_context_104ad7_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                fields=["initiator_type", "initiator_id"],
                name="transaction_initiat_abb007_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                ...
                name="transaction_target__4aa04f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                fields=["expires_at"], name="transaction_expires_d6d676_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                fields=["status", "outcome_executed"],
                name="transaction_status_943fb2_idx",
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="transaction_transac_45974c_idx",
            ),
        ),
    ]
