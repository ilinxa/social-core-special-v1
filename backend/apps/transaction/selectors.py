...
class TransactionSelector:
    ...
    @staticmethod
    def exists_active(
        *, transaction_type: str, initiator_id: UUID, target_id: UUID,
    ) -> bool:
    ...
    def has_active_in_conflict_group(
        *, conflict_group: str, user_id: UUID,
        context_type: str, context_id: UUID,
    ...
    def _user_as_initiator_q(user_id: UUID) -> "Q":
        ...
        from django.db.models import Q
        return (
            Q(initiator_id=user_id, initiator_type="user")
            | Q(
    ...
    def list_for_user_as_initiator(
        *, user_id: UUID, include_terminal: bool = False,
    ) -> QuerySet:
    ...
    @staticmethod
    def get_by_form_response_id(*, form_response_id: UUID) -> Optional[Transaction]:
        return Transaction.objects.filter(
    ...
    def get_form_mapping_for_transaction(*, transaction: Transaction):
        ...
        return TransactionFormMapping.objects.filter(
