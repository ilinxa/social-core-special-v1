...
urlpatterns = [
    ...
    path(
        "<slug:slug>/profile/visibility/",
        BusinessProfileVisibilityView.as_view(),
    ...
    path(
        ...
        rbac_views.BusinessRoleListView.as_view(),
        name="role-list",
    ),
    path(
        "<slug:business_slug>/roles/<uuid:role_id>/",
        rbac_views.BusinessRoleDetailView.as_view(),
        name="role-detail",
    ),
    path(
        "<slug:business_slug>/roles/<uuid:role_id>/permissions/",
        rbac_views.BusinessRolePermissionView.as_view(),
        name="role-permissions",
    ),
    # RBAC - Members
    path(
        "<slug:business_slug>/members/",
        rbac_views.BusinessMemberListView.as_view(),
        name="member-list",
    ),
    path(
        "<slug:business_slug>/members/leave/",
        rbac_views.BusinessMemberLeaveView.as_view(),
        name="member-leave",
    ),
    path(
        "<slug:business_slug>/members/<uuid:membership_id>/",
        rbac_views.BusinessMemberDetailView.as_view(),
        name="member-detail",
    ),
    path(
        "<slug:business_slug>/members/<uuid:membership_id>/role/",
        rbac_views.BusinessMemberRoleView.as_view(),
        name="member-role",
    ),
    path(
        "<slug:business_slug>/members/<uuid:membership_id>/suspend/",
        rbac_views.BusinessMemberSuspendView.as_view(),
        name="member-suspend",
    ),
    path(
        "<slug:business_slug>/members/<uuid:membership_id>/remove/",
        rbac_views.BusinessMemberRemoveView.as_view(),
        name="member-remove",
    ),
    path(
        "<slug:business_slug>/members/<uuid:membership_id>/ban/",
        rbac_views.BusinessMemberBanView.as_view(),
        name="member-ban",
    ),
    path(
        "<slug:business_slug>/members/<uuid:membership_id>/reactivate/",
        rbac_views.BusinessMemberReactivateView.as_view(),
