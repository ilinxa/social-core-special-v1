...
class UserProfileOutputSerializer(BaseOutputSerializer):
    ...
    def _get_image_url(self, image_field) -> str | None:
...
class ApprovedCreatorSerializer(BaseOutputSerializer):
    """Slim serializer for users with business creation permission."""
