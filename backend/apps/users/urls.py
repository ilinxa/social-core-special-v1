...
urlpatterns = [
    ...
    path('me/profile/visibility/', views.UserProfileVisibilityView.as_view(), name='profile-visibility'),
    # RBAC memberships (user's own memberships)
    path('me/memberships/', rbac_views.MyMembershipsListView.as_view(), name='my-memberships'),
    path('me/memberships/<uuid:membership_id>/', rbac_views.MyMembershipDetailView.as_view(), name='my-membership-detail'),
