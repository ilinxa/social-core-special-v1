...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='message',
            name='content_type',
            field=models.CharField(choices=[('text', 'Text'), ('system', 'System'), ('image', 'Image')], default='text', max_length=20),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_type', models.CharField(choices=[('image', 'Image')], max_length=20)),
            ...
            options={
                ...
                'ordering': ['created_at'],
                'indexes': [models.Index(fields=['message'], name='chat_attach_msg_idx'), models.Index(fields=['conversation'], name='chat_attach_conv_idx'), models.Index(condition=models.Q(('message__isnull', True)), fields=['message'], name='chat_attach_orphan_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Timestamp when record was last updated')),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, help_text='Unique identifier (UUID v4)', primary_key=True, serialize=False)),
                ('reaction', models.CharField(choices=[('like', '👍'), ('heart', '❤️'), ('laugh', '😂'), ('wow', '😮'), ('sad', '😢'), ('angry', '😡')], max_length=20)),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['message'], name='chat_reaction_msg_idx')],
                'constraints': [models.UniqueConstraint(fields=('message', 'user', 'reaction'), name='unique_message_user_reaction')],
            },
        ),
    ]
