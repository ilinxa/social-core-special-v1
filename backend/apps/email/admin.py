...
class EmailLogAdmin(admin.ModelAdmin):
    ...
    readonly_fields = [
        ...
        'subject', 'html_body', 'text_body', 'context',
        'status', 'message_id',
    ...
    fieldsets = (
        ('Recipient', {
            'fields': ('id', 'to_email', 'from_email', 'reply_to')
        }),
        ('Template', {
            'fields': ('template', 'template_name', 'template_version')
        }),
        ('Content', {
        ...
        ('Status', {
            'fields': ('status', 'message_id', 'error_message', 'error_code')
        }),
        ('Retry Info', {
        ...
        ('Bounce Details', {
            'fields': ('bounce_type', 'bounce_subtype'),
            'classes': ('collapse',)
        }),
    )
