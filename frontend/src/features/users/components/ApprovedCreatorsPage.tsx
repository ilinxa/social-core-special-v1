...
import { useApprovedCreators } from "@/features/users/hooks/use-user-queries";
import type { ApprovedCreatorItem } from "@/types";

export function ApprovedCreatorsPage() {
  ...
  const { data, isLoading } = useApprovedCreators(params);
